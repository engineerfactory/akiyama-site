...
export default withI18next({ ns: 'common' })(NewsPage);

export const pageQuery = graphql`
  query newsByLocale($locale: String!) {
    site {
      siteMetadata {
        title
      }
    ...
    page: markdownRemark(
      frontmatter: { templateKey: { eq: "news-page" }, locale: { eq: $locale } }
    ) {
      frontmatter {
        title
        heading
