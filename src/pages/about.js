...
export default withI18next({ ns: 'common' })(AboutPage);

export const pageQuery = graphql`
  query aboutByLocale($locale: String!) {
    site {
      siteMetadata {
        title
      }
    ...
    page: markdownRemark(
      frontmatter: { templateKey: { eq: "about-page" }, locale: { eq: $locale } }
    ) {
      frontmatter {
        title
        heading
